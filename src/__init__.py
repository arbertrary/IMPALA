...
audio1 = os.path.join(BASE_DIR, "data/audio_csvfiles/energy", "blade.csv")
audio2 = os.path.join(BASE_DIR, "data/audio_csvfiles/energy", "hellboy.csv")
audio3 = os.path.join(BASE_DIR, "data/audio_csvfiles/energy", "predator.csv")
audio4 = os.path.join(BASE_DIR, "data/audio_csvfiles/energy", "scream_ger.csv")
audio5 = os.path.join(BASE_DIR, "data/audio_csvfiles/energy", "star-wars-4.csv")
audio6 = os.path.join(BASE_DIR, "data/audio_csvfiles/energy", "the-matrix.csv")
audio7 = os.path.join(BASE_DIR, "data/audio_csvfiles/energy", "indiana-jones-3_ger.csv")
