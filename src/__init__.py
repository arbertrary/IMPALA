...
fountain7 = os.path.join(BASE_DIR, "data/all_moviescripts", "indiana-jones-and-the-last-crusade.txt")
...
script7 = os.path.join(BASE_DIR, "data/manually_annotated", "indiana-jones-3_man.xml")
...
subs7 = os.path.join(BASE_DIR, "data/data_subtitles/", "indiana-jones-and-the-last-crusade_subs.xml")
